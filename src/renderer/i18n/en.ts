export default {
  ...
  files: {
    ...
    searchIn: 'Search in this folder…', selectAll: 'Select all', invertSelection: 'Invert selection', pathPlaceholder: 'Enter a path…', noPreview: 'No preview available', tooLargeEditor: 'File too large for the built-in editor — opened with the system app instead',
  },
  editor: {
  ...
  vault: {
    ...
    mismatch: 'Passwords do not match', tooShort: 'At least 8 characters', security: 'AES-256-GCM • PBKDF2-SHA512 600k iterations • Local only', autoLock: 'Auto-lock after inactivity',
  },
  shortcuts: {
